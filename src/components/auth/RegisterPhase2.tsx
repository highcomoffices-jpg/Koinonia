      ...
      <Card className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Select
            ...
            options={cityOptions}
            placeholder={isLoadingCities ? 'Chargement des villes...' : t('register.phase2.selectCity') || 'Sélectionnez votre ville'}
            error={errors.cityId}
            disabled={isLoading || isLoadingCities || !user?.country?.id}
          ...
          <Select
            ...
            placeholder={isLoadingConfessions ? 'Chargement des confessions...' : t('register.phase2.selectConfession') || 'Sélectionnez votre confession'}
            error={errors.confessionId}
            disabled={isLoading || isLoadingConfessions}
            loading={isLoadingConfessions}
          />
